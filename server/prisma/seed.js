...
async function main() {
    ...
    const scheduleSlots = [
        { day: client_1.DayOfWeek.MONDAY, start: '08:30', end: '09:30', room: 'Room 101', subjectId: math10.id, teacherId: teacher1User.teacherProfile.id },
        { day: client_1.DayOfWeek.MONDAY, start: '09:45', end: '10:45', room: 'Lab 2', subjectId: physics10.id, teacherId: teacher2User.teacherProfile.id },
        { day: client_1.DayOfWeek.MONDAY, start: '11:00', end: '12:00', room: 'Room 101', subjectId: english10.id, teacherId: teacher3User.teacherProfile.id },
        { day: client_1.DayOfWeek.TUESDAY, start: '08:30', end: '09:30', room: 'Room 101', subjectId: cs10.id, teacherId: teacher2User.teacherProfile.id },
        { day: client_1.DayOfWeek.TUESDAY, start: '09:45', end: '10:45', room: 'Room 101', subjectId: math10.id, teacherId: teacher1User.teacherProfile.id },
        { day: client_1.DayOfWeek.WEDNESDAY, start: '08:30', end: '09:30', room: 'Lab 2', subjectId: physics10.id, teacherId: teacher2User.teacherProfile.id },
        { day: client_1.DayOfWeek.WEDNESDAY, start: '10:00', end: '11:00', room: 'Room 101', subjectId: english10.id, teacherId: teacher3User.teacherProfile.id },
        { day: client_1.DayOfWeek.THURSDAY, start: '08:30', end: '09:30', room: 'Room 101', subjectId: math10.id, teacherId: teacher1User.teacherProfile.id },
        { day: client_1.DayOfWeek.THURSDAY, start: '10:00', end: '11:00', room: 'Computer Lab 1', subjectId: cs10.id, teacherId: teacher2User.teacherProfile.id },
        { day: client_1.DayOfWeek.FRIDAY, start: '09:00', end: '10:00', room: 'Room 101', subjectId: english10.id, teacherId: teacher3User.teacherProfile.id },
    ];
    ...
    for (let d = 0; d < 7; d++) {
        ...
        for (const student of createdStudents) {
            ...
            const status = isAbsent ? client_1.AttendanceStatus.ABSENT : isLate ? client_1.AttendanceStatus.LATE : client_1.AttendanceStatus.PRESENT;
    ...
    const examMath = await prisma.exam.create({
        data: {
            ...
            type: client_1.ExamType.MIDTERM,
            term: 'Spring 2026',
            maxMarks: 100,
            passingMarks: 40,
    ...
    const examEnglish = await prisma.exam.create({
        data: {
            ...
            type: client_1.ExamType.ASSIGNMENT,
            term: 'Spring 2026',
            maxMarks: 50,
            passingMarks: 20,
    ...
    for (let i = 0; i < createdStudents.length; i++) {
        ...
        await prisma.feeInvoice.create({
            data: {
                ...
                status: client_1.FeeStatus.PAID,
        ...
        await prisma.feeInvoice.create({
            data: {
                ...
                status: isPending ? client_1.FeeStatus.PENDING : client_1.FeeStatus.PAID,
    ...
    await prisma.announcement.create({
        data: {
            ...
            content: 'The comprehensive schedule for Spring 2026 Mid-Term Examinations is now officially published. Please review your personalized timetable and study materials under the Exams module.',
            targetRole: client_1.NoticeTarget.ALL,
    ...
    await prisma.announcement.create({
        data: {
            ...
            content: 'Submissions for project abstracts are open until April 10th. Students interested in robotics, environmental science, or AI projects should register with Dr. Chang.',
            targetRole: client_1.NoticeTarget.ALL,
            priority: client_1.NoticePriority.MEDIUM,
    ...
    await prisma.announcement.create({
        data: {
            ...
            content: 'Mandatory faculty training on Friday at 3:30 PM in the Conference Hall. We will explore new digital grading tools and collaborative syllabus planning.',
            targetRole: client_1.NoticeTarget.TEACHER,
            priority: client_1.NoticePriority.HIGH,
            authorId: adminUser.id,
        },
    });
